...
namespace KBOLib._Util
{
    public class CacheUtil
    {
        ...
        private static Database kboDB = EnterpriseLibraryContainer.Current.GetInstance<Database>("kbo_db");
        private static Database kboDB2 = EnterpriseLibraryContainer.Current.GetInstance<Database>("kbo_db2");
        private static Database minorDB = EnterpriseLibraryContainer.Current.GetInstance<Database>("kbo_minor");
        private static Database indieDB = EnterpriseLibraryContainer.Current.GetInstance<Database>("kbo_minor_indie");
        ...
        public static DataSet GetHistoryPit(int cho, String param)
        {
            if (cho > KBO_HISTORY_PITCHER_KEY.Length)
            {
                return null;
            }

            DataSet ds = GetDataSet(KBO_HISTORY_PITCHER_KEY[cho]);

            if (ds == null)
            {
                DbCommand cmd = kboDB.GetStoredProcCommand("PROC_KBO_DB_PITTOTAL_RECORD_S");
                kboDB.AddInParameter(cmd, "@CK", DbType.String, param);

                ds = kboDB.ExecuteDataSet(cmd);
                SetDataSet(ds, KBO_HISTORY_PITCHER_KEY[cho], 1, 0, 0, 0);
            }

            return ds;
        }

        public static DataSet GetHistoryHit(int cho, String param)
        {
            if (cho > KBO_HISTORY_HITTER_KEY.Length)
            {
                return null;
            }

            DataSet ds = GetDataSet(KBO_HISTORY_HITTER_KEY[cho]);

            if (ds == null)
            {
                DbCommand cmd = kboDB.GetStoredProcCommand("PROC_KBO_DB_BATTOTAL_RECORD_S");
                kboDB.AddInParameter(cmd, "@CK", DbType.String, param);

                ds = kboDB.ExecuteDataSet(cmd);
                SetDataSet(ds, KBO_HISTORY_HITTER_KEY[cho], 1, 0, 0, 0);
            }
        ...
        /// </summary>
        /// <returns>DataSet</returns>
        public static DataSet GetBoxScore(string param, string gmkey, string year)
        {
            string boxScoreCache = KBO_BOXSCORE_KEY + "_" + year + "_" + gmkey;

            DataSet ds = GetDataSet(boxScoreCache);

            if (ds == null)
            {
                DbCommand cmd = kboDB.GetStoredProcCommand("PROC_KBO_DB_BOXSCORE_S");
                kboDB.AddInParameter(cmd, "@GYEAR", DbType.String, gmkey);
                kboDB.AddInParameter(cmd, "@GMKEY", DbType.String, year);

                ds = kboDB.ExecuteDataSet(cmd);
                SetDataSet(ds, boxScoreCache, 0, 0, 2, 0);
            }
        ...
        public static DataTable GetCareerTeam()
        {
            ...
            if (ds == null)
            {
                ...
                string[,] teamArray = { { "1985", "HH", "빙그레", "이글스" }, { "1989", "SB", "쌍방울", "레이더스" }, { "1990", "SB", "쌍방울", "레이더스" }, { "2000", "SB", "쌍방울", "레이더스" }, { "2008", "HD", "현대", "유니콘스" }, { "2011", "NC", "NC", "다이노스" }, { "2012", "NC", "NC", "다이노스" }, { "2013", "KT", "kt", "wiz" }, { "2014", "KT", "kt", "wiz" } };
        ...
        #region 년도별 누적 관중수
        public static DataSet GetMainCrowd(String gameYear)
        {
            DataSet ds = GetDataSet(YEAR_CROWD_KEY);

            if (ds == null)
            {
                DbCommand cmd = kboDB.GetStoredProcCommand("PROC_KBO_DB_CROWD_YEAR_S");
                kboDB.AddInParameter(cmd, "@GYEAR", DbType.String, gameYear);

                ds = kboDB.ExecuteDataSet(cmd);
                SetDataSet(ds, YEAR_CROWD_KEY, 0, 0, 5, 0);
            }
        ...
        #region 기록실 (투수 TOP 5, 타자 TOP 5)
        /// <summary>
        /// 1군 투수 TOP 5 데이터 캐싱
        /// </summary>
        /// <returns>DataSet</returns>
        public static DataSet GetKboPitTop5()
        {
            DataSet ds = GetDataSet(KBO_PITCHER_TOP5_KEY);

            if (ds == null)
            {
                DbCommand cmd = kboDB.GetStoredProcCommand("PROC_KBO_DB_PITCHER_TOP5_S");
                kboDB.AddInParameter(cmd, "@GYEAR", DbType.String, Baseball.KBO_END_YEAR);

                ds = kboDB.ExecuteDataSet(cmd);
                SetDataSet(ds, KBO_PITCHER_TOP5_KEY, 0, 0, 5, 0);
            }
        ...
        /// </summary>
        /// <returns>DataSet</returns>
        public static DataSet GetKboHitTop5()
        {
            DataSet ds = GetDataSet(KBO_HITTER_TOP5_KEY);

            if (ds == null)
            {
                DbCommand cmd = kboDB.GetStoredProcCommand("PROC_KBO_DB_HITTER_TOP5_S");
                kboDB.AddInParameter(cmd, "@GYEAR", DbType.String, Baseball.KBO_END_YEAR);

                ds = kboDB.ExecuteDataSet(cmd);
                SetDataSet(ds, KBO_HITTER_TOP5_KEY, 0, 0, 5, 0);
            }
        ...
        #region 퓨처스기록실 (투수 TOP 5, 타자 TOP 5)
        /// <summary>
        /// 퓨처스 투수 TOP 5 데이터 캐싱
        /// </summary>
        /// <returns>DataSet</returns>
        public static DataSet GetFuturesPitTop5()
        {
            DataSet ds = GetDataSet(FUTURES_PITCHER_TOP5_KEY);

            if (ds == null)
            {
                DbCommand cmd = minorDB.GetStoredProcCommand("PROC_KBO_MINOR_PITCHER_TOP5_S");
                minorDB.AddInParameter(cmd, "@GYEAR", DbType.String, Baseball.FUTURES_END_YEAR);

                ds = minorDB.ExecuteDataSet(cmd);
                SetDataSet(ds, FUTURES_PITCHER_TOP5_KEY, 0, 0, 5, 0);
            }
        ...
        /// </summary>
        /// <returns>DataSet</returns>
        public static DataSet GetFuturesHitTop5()
        {
            DataSet ds = GetDataSet(FUTURES_HITTER_TOP5_KEY);

            if (ds == null)
            {
                DbCommand cmd = minorDB.GetStoredProcCommand("PROC_KBO_MINOR_HITTER_TOP5_S");
                minorDB.AddInParameter(cmd, "@GYEAR", DbType.String, Baseball.FUTURES_END_YEAR);

                ds = minorDB.ExecuteDataSet(cmd);
                SetDataSet(ds, FUTURES_HITTER_TOP5_KEY, 0, 0, 5, 0);
            }
        ...
        /// </summary>
        /// <returns>DataSet</returns>
        public static DataSet GetSeasonSchedule(string gameYear, string gameMonth, string team)
        {
            DataSet ds = GetDataSet(KBO_SEASON_SCHEDULE_KEY);

            if (ds == null)
            {
                DbCommand cmd = kboDB.GetStoredProcCommand("PROC_KBO_DB_KBO_SCHEDULE_BASE_LIST_S");
                kboDB.AddInParameter(cmd, "@GYEAR", DbType.String, gameYear);
                kboDB.AddInParameter(cmd, "@GMONTH", DbType.String, gameMonth);
                kboDB.AddInParameter(cmd, "@TEAM", DbType.String, team);

                ds = kboDB.ExecuteDataSet(cmd);
                SetDataSet(ds, KBO_SEASON_SCHEDULE_KEY, 0, 5, 0, 0);
            }
        ...
        {
            String CacheKey = GAMECAST_SCOREBOARD_KEY + "_" + leId + "_" + gameYear + "_" + gameId;
            DataSet ds = GetDataSet(CacheKey);
        ...
        {
            String CacheKey = GAMECAST_OTHER_GAME_KEY + "_" + leId + "_" + gameYear + "_" + gameId;
            DataSet ds = GetDataSet(CacheKey);
        ...
        {
            String CacheKey = GAMECAST_GROUND_INFO_KEY + "_" + leId + "_" + gameYear + "_" + gameId;
            DataSet ds = GetDataSet(CacheKey);
        ...
        {
            String CacheKey = GAMECAST_LINEUP_INFO_KEY + "_" + leId + "_" + gameYear + "_" + gameId;
            DataSet ds = GetDataSet(CacheKey);
        ...
        {
            String CacheKey = GAMECAST_LIVETEXT_KEY + "_" + leId + "_" + gameYear + "_" + gameId;
            DataSet ds = GetDataSet(CacheKey);
        ...
        {
            String CacheKey = GAMECAST_PLAYER_INFO_KEY + "_" + leId + "_" + gameYear + "_" + gameId;
            DataSet ds = GetDataSet(CacheKey);
        ...
        {
            String CacheKey = GAMECAST_BOXSCORE_KEY + "_" + leId + "_" + gameYear + "_" + gameId;
            DataSet ds = GetDataSet(CacheKey);
        ...
        {
            String CacheKey = KBO_TV_HIGHLIGHT_KEY;
            DataSet ds = GetDataSet(CacheKey);
        ...
        public static DataSet GetKboGameLastDate(int leId, int srId, string searchDate)
        {
            ...
            if (ds == null)
            {
                ...
                kboDB.AddInParameter(cmd, "@SEARCH_DT", DbType.Date, searchDate);
