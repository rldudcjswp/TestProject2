...
namespace KBOLib._Util
{
    ...
    public class ManagerInfoUtil
    {
        ...
        {
            string authList = "";
            string[,] folderAuthArray = {{"/BOARD/","1"}, {"/ETC/","1"}, {"/EVENT/","1"}, {"/MEMBER/","1|2"}, {"/NEWS/","1|2"}
                                        , {"/PLAYER/","1"}, {"/RECORDBOARD/","1|2"}, {"/SCHEDULE/","1|2"}, {"/VIDEO/","1|2"}, {"/CAREER/","1|2"}};

            for (int i = 0; i < folderAuthArray.Length; i++)
            {
