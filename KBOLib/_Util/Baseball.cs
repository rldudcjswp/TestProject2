...
namespace KBOLib._Util
{
    ...
    public class Baseball
    {
        ...
        public const int KBO_DETAIL_START_YEAR = 2002; // KBO 1군 세부 기록 제공 시작 년도
        public const int KBO_REGULAR_SR_END_YEAR = 2017;  // KBO 1군 정규시즌 최종 년도
        public const int KBO_END_YEAR = 2017;  // KBO 1군 최종 년도
        ...
        public const int FUTURES_END_YEAR = 2017; // 퓨처스 최종 년도
        ...
        ***********************************************************************/
        ...
        //// 현재 사용중인 경기장 정보
        public static String[] stadium = {"고양","고척","군산","광주","기장","대구","대전","마산","문학","사직","상동","수원","울산","인천","잠실","목동","제주","청주","포항","팻코", "파크", "화성"
        ...
        public static String[] minorStadium = {
                                                ...
                                                , "이천", "이천(두산)", "이천(LG)", "익산", "잠실", "청주", "춘천", "포항"
                                                , "함평", "화성"
                                              };

        // 현재 사용중인 팀정보 // 2015-10-05 yeeun, 반상호대리 요청 {"WO","우리","넥센 히어로즈"}
        public static String[,] team ={{"SS","삼성","삼성 라이온즈"},{"HD","현대","현대 유니콘스"},{"OB","두산","두산 베어스"},{"HT","KIA","KIA 타이거즈"},{"LT","롯데","롯데 자이언츠"}
                                            ,{"HH","한화","한화 이글스"},{"SK","SK","SK 와이번스"},{"LG","LG","LG 트윈스"},{"WO","넥센","넥센 히어로즈"},{"NC","NC","NC 다이노스"},{"KT","kt","KT 위즈"}
                                            ,{"SM","상무","상무"},{"PL","경찰","경찰"},{"WE","나눔","올스타"},{"EA","드림","올스타"},{"K1","대표팀","대표팀"}
                                            ,{"K2","상비군","상비군"},{"PO","준결승","준결승 진출팀"},{"SB","남부","남부"},{"NB","북부","북부"}
                                            ,{"KR","한국","한국"},{"JP","일본","일본"},{"TW","대만","대만"},{"US","미국","미국"},{"DO","도미니카","도미니카"}
        ...
        public static string[,] gameType = { { "0", "REGULAR" }, { "4", "EXHIBITION" }, { "51", "WBC" }, { "31", "Asia Series" }, {"5", "Allstar game"}
                                            ...
                                            , { "24", "Korean Series game6" }, { "25", "Korean Series game7" }};
        
        //더블헤더 정보
        public static string[,] doubleHead = { { "0", "더블헤더 아님" }, { "1", "더블헤더 1차전" }, { "2", "더블헤더 2차전" } };
        ...
        public static DataTable SetTeamList(string leagueId, string seasonId, string groupSc)
        {
            ...
            {
                dvTeam.Sort = "LE_ID, SEASON_ID, GROUP_SC, RANK_NO ASC";
            }
