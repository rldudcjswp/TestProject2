...
namespace KBOLib._Util
{
    public class CommonUtil
    {
        ...
        public static string[,] searchSection = { { "NAME", "이름" }, { "ID", "아이디" }, { "RESIDENT", "주민번호" } };
        ...
        public static void RedirectHttps()
        {
            ...
            {
                string redirectUrl = HttpContext.Current.Request.Url.AbsoluteUri.Replace("http:", "https:");
        ...
        public static void RedirectHttp()
        {
            if (HttpContext.Current.Request.IsSecureConnection)
            {
                string redirectUrl = HttpContext.Current.Request.Url.AbsoluteUri.Replace("https:", "http:");
                HttpContext.Current.Response.Redirect(redirectUrl);
            }
        }
